...
@register("srpo")
class SRPORewardManager(AbstractRewardManager):
    ...
    def compute_for_rollout(self, batch: DataProto, return_dict: bool = False) -> torch.Tensor | dict[str, Any]:
        """Compute SRPO rewards; advantages are handled by adv estimator."""
    ...
    def __call__(self, data: DataProto, return_dict: bool = False) -> torch.Tensor | dict[str, Any]:
        """Compute SRPO rewards; advantages are computed separately by adv estimator."""
