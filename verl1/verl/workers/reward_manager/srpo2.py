...
@register("srpo2")
class SRPO2RewardManager(AbstractRewardManager):
    ...
    def compute_for_rollout(self, batch: DataProto, return_dict: bool = False) -> torch.Tensor | dict[str, Any]:
        """Compute SRPO2 rewards; advantages are handled by adv estimator."""
    ...
    def __call__(self, data: DataProto, return_dict: bool = False) -> torch.Tensor | dict[str, Any]:
        """Compute SRPO2 rewards; advantages are computed separately by adv estimator."""
