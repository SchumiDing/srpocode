...
class RLHFDataset(Dataset):
    ...
    def maybe_filter_out_long_prompts(self, dataframe: datasets.Dataset = None):
        ...
        if self.filter_overlong_prompts:
            ...
            # print(f"first row: {dataframe[0]}")
            # print(f"first row length: {doc2len(dataframe[0])}")
            ...
            print(f"filter dataset len ddddd: {len(dataframe)}")
        return dataframe
    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None:
            ...
            input_ids = model_inputs.pop("input_ids")
            attention_mask = model_inputs.pop("attention_mask")
        # print("raw_prompt", raw_prompt, flush=True)
        ...
        # print(f"row_dict: {row_dict}", flush=True)
        # print(f"row_dict: {row_dict['reward_model']['ground_truth']}", flush=True)
        return row_dict
